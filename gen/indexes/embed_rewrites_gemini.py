"""Embed all rewrites with gemini-embedding-001 (OpenRouter), crash-safe + resumable. Adapted from embed_rewrites.py.
...
URL, MODEL, DIM = 'https://openrouter.ai/api/v1/embeddings', 'google/gemini-embedding-001', 3072
REWRITES = f'{ROOT}/gen/rewrites.jsonl'
D = f'{ROOT}/emb_gemini'; os.makedirs(D, exist_ok=True)
